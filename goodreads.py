...
def get_artist_letter(letter):
    ...
    URL = "https://www.besteveralbums.com/objectindex.php?o=band&l={}".format(letter)
    ...
    for record in mydivs1:
        ...
        artist_1 = {"alt_country":alt_country,
            "country":country,
        ...
        second_artist = art_string.split("</a></td>")[0].split("<td class=\"chartstring\"")[1]
        ...
        artist_2 = {"alt_country":alt_country,
            "country":country,
            "country_img":country_img,
            "link":link,
            "artist":artist}
