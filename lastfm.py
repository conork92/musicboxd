...
def get_artist(artist,api_key):
    artist  = "http://ws.audioscrobbler.com/2.0/?method=artist.search&artist={}&api_key={}&format=json".format(artist,api_key)
    artist_json = requests.get(artist)
    return artist_json

def get_artist_info(artist,api_key):
    artist  = "http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist={}&api_key={}&format=json".format(artist,api_key)
